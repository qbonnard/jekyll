Feature: Create sites
  ...
  Scenario: Basic site with extract tag
    Given I have a _includes directory
    And I have an "index.html" page that contains "Basic Site with extract tag: {% extract about.textile %} {% after ignored until %} {% before ignored from %} {% endextract %}"
    And I have an "_includes/about.textile" file that contains "ignored until"
    And I have an "_includes/about.textile" file that also contains "extracted line"
    And I have an "_includes/about.textile" file that also contains "ignored from"
    When I run jekyll
    Then the _site directory should exist
    And I should see "Basic Site with extract tag: extracted line" in "_site/index.html"
